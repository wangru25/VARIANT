...
class MutationProcessor:
    ...
    def _process_root_variants(self, snp_records: List[Dict], prefix: str, virus_processor=None, segment: Optional[str] = None) -> None:
        ...
        """
        from src.utils.mutation_utils import split_multi_protein_mutations, classify_mutation_type, convert_key_to_int, sort_dict_by_consecutive_keys, detect_hot_mutation, format_amino_acid_change_for_csv
        from src.core.reference_genome import ReferenceGenome
