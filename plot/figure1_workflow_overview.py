#!/usr/bin/env python3
"""
Figure 1: VARIANT Workflow Overview
===================================

This script creates a comprehensive workflow diagram showing the complete VARIANT pipeline
from input data to final output, highlighting all major components and data flows.
